...
venue: "ELIXIR - University of Bergen: R for reproducible scientific analysis"        # brief name of host site without address (e.g., "Euphoric State University")
address: "Bioblokken Room 520B1, High Technology Centre, Thormøhlens Gt 55, 5008 Bergen, Norway"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
latlng: "60.381,5.333"       # decimal latitude and longitude of workshop venue (e.g., "41.7901128,-87.6007318" - use https://www.latlong.net/)
humandate: "1-3 April 2019"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
enddate: 2019-04-03        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Joaquín Morís Fernández","David Grellscheid"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["David Dolan","Carl Jones","Ståle Nygård","Kjell Petersen","Elsa du Plessis"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["david.grellscheid@uib.no"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
collaborative_notes: "https://pad.carpentries.org/2019-04-01-ELIXIR-NORWAY_BERGEN"            # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
